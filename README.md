...
Only for advanced users. If you simply want to install the pack, grab it from [here](https://github.com/GhostlyDark/SM64-Reloaded-GS/releases/latest) instead.
